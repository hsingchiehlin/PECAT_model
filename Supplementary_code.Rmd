...
#Plotting
tiff(width = 6, height = 3.2, "plots/Figure.S1_sensitivity analysis_chemical-sepecific para. for Fabs.tiff", units = "in", res=400)
ggplot() + 
  # Baseline
...
tiff(width = 6, height = 4.5, "plots/Figure.S2_Scatter plot_ivive.tiff", units = "in", res=400)
ggplot() +           
...
tiff(width = 6, height = 4.5, "plots/Figure.S2_Histogram_residuals_ivive.tiff", units = "in", res=300)
...
ggplot() +           
  ...
  scale_y_log10(lim = c(1E-7, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_duo) = log10(P_col) + 0.584", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_duo) = -0.197 * log10(P_col) - 6.002, R2 = 0.0009", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Duodenum")+
...
ggplot() +           
  ...
  scale_y_log10(lim = c(1E-7, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_jej) = log10(P_col) - 0.630", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_jej) = 0.397 * log10(P_col) - 2.402, R2 = 0.18", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Jejunum")+
  figure.setting
...
ggplot() +           
  ...
  scale_y_log10(lim = c(1E-8, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_ile) = log10(P_col) + 0.635", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_ile) = 0.463 * log10(P_col) - 1.200, R2 = 0.23", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Ileum")+
  figure.setting

jpeg(width = 15, height = 7.5, "plots/Figure S3A_Scatter plot_seg_ratio_all.jpeg", units = "in", res=400)
...
# ------------------- segment-specific scaling Part (rm outlier) -------------------
Seg_Papp_rawdata <- read.csv("DATA/SUPP_Site-specific_Papp_rawdata.csv")
...
Fig.1.4 <-
  ...
  scale_y_log10(lim = c(1E-8, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_duo) = log10(P_col) + 0.105, R2 = 0.91", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_duo) = 0.568 * log10(P_col) - 2.139, R2 = 0.91", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Duodenum")+
  labs(title="Compare with colon permeability") + 
...
Fig.1.5 <-
  ...
  scale_y_log10(lim = c(1E-8, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_jej) = log10(P_col) + 0.492, R2 = 0.48", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_jej) = 0.734 * log10(P_col) - 0.797, R2 = 0.48", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Jejunum")+
  figure.setting
...
Fig.1.6 <-
  ...
  scale_y_log10(lim = c(1E-8, 1E-1),
                breaks = trans_breaks("log10", function(x) 10^x, n = 6),
                labels = trans_format("log10", math_format(10^.x)))+
  annotate(geom="text", x=5E-6, y=1E-2, label="Model 1: log10(P_ile) = log10(P_col) + 0.382, R2 = 0.75", size=3, color = "blue")+
  annotate(geom="text", x=5E-6, y=5E-3, label="Model 2: log10(P_ile) = 1.054 * log10(P_col) + 0.636, R2 = 0.75", size=3, color = "red")+
  theme_bw() + 
  xlab("P_Colon") +
  ylab("P_Ileum")+
  figure.setting

jpeg(width = 15, height = 7.5, "plots/Figure S3B_Scatter plot_seg_ratio_rm.jpeg", units = "in", res=400)
Fig.1.1 + Fig.1.2 + Fig.1.3 + Fig.1.4 + Fig.1.5 + Fig.1.6 + plot_layout(widths = c(1/3, 1/3, 1/3), height = c(1/2, 1/2))
dev.off()
...
tiff(width = 10, height = 4, "plots/Figure.S5_IVIVE ratio.inhibitor.tiff", units = "in", res=400)
...
mu_pH <- ddply(pH_data, "pH.group", summarise, grp.mean=mean(log.ratio), grp.SD=sd(log.ratio),
                                               Geo.mean=exp(mean(log(ivive_ratio))), Geo.SD=geoSD(ivive_ratio))
...
tiff(width = 12, height = 4, "plots/Figure.S6_IVIVE ratio.pH group.tiff", units = "in", res=400)
