...
# Figure S2A
tiff(width = 7.5, height = 6.54, "plots/Figure.S2a_corr.maxtri_jeju_ratio_log.tiff", units = "in", res=600)
...
tiff(width = 7.5, height = 6.54, "plots/Figure.S2b_corr.maxtri_colon_ratio_log.tiff", units = "in", res=600)
pairs(log(Peff.ratio.col[,2:4]), lower.panel = NULL, 
      upper.panel = upper.panel)
dev.off()
...
```{r Plotting FigureS3_relationship of permeability and %abs with new data (162 drugs)}
...
```{r Risk prioritization and Plotting Figure7_OED compare with exposure}
# load data
